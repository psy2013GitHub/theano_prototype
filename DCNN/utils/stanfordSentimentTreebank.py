...
# -*- coding: utf-8 -*-
'''
    @from: https://github.com/aonotas/dynamic_cnn_for_nlp.git
...
# データセットの読み込み
def load_stanfordSentimentTreebank_dataset(sst_data_path, normalize=True, skip_unknown_words=True, datatype=5):
    csv_filename = sst_data_path + '/stanfordSentimentTreebank/datasetSplit.txt'
    train_ids, test_ids, dev_ids = load_splitset(csv_filename)
    csv_filename = sst_data_path + '/stanfordSentimentTreebank/datasetSentences.txt'
    ...
    train_scores = [tree_sentence[1] for tree_sentence in open(sst_data_path+'/trees/train.txt')]
    test_scores  = [tree_sentence[1] for tree_sentence in open(sst_data_path+'/trees/test.txt')]
    dev_scores   = [tree_sentence[1] for tree_sentence in open(sst_data_path+'/trees/dev.txt')]
